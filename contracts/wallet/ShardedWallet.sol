...
contract ShardedWallet is Ownable, ERC20, ERC1363Approve {
    ...
    bytes32 public constant ALLOW_GOVERNANCE_UPGRADE =
        0xedde61aea0459bc05d70dd3441790ccfb6c17980a380201b00eca6f9ef50452a;

    IGovernance public governance;
    address public artistWallet;
    uint256 public pricePerShard;
    ...
    function retrieve(address newOwner) external {
    ...
    function moduleMint(address to, uint256 value) external onlyModule {
        ERC20._mint(to, value);
    }

    function moduleBurn(address from, uint256 value) external onlyModule {
    ...
    function moduleTransferOwnership(address to) external onlyModule {
        Ownable._setOwner(to);
    }

    function updateGovernance(address newGovernance) external onlyModule {
